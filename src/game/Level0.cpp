...
/// EK-Feature Bugreport thx to Charlie2025 for basiccode
bool ChatHandler::HandleBugReportCommand(const char* args)
{
	...
	loginDatabase.PExecute(" INSERT INTO bug_report (name, reporter_id, realm, text) VALUES ('%s', %u, %u, '%s')", m_session->GetPlayerName(), acc_id, realm, obsah.c_str() );   
